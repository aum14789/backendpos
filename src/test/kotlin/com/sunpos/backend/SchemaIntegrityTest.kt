...
class SchemaIntegrityTest {
    ...
    fun `verify all JdbcRepository entity fields exist in V1 baseline schema DDL`() {
        ...
        val entityClasses: List<Pair<Class<*>, String>> = listOf(
            ...
            com.sunpos.backend.domain.order.ManualDiscountLog::class.java to "manual_discount_logs",
            com.sunpos.backend.domain.order.CashDrawerLog::class.java to "cash_drawer_logs",
            com.sunpos.backend.domain.order.OrderCancellationLog::class.java to "order_cancellation_logs",
            com.sunpos.backend.domain.order.ShiftPayoutLog::class.java to "shift_payout_logs",
            com.sunpos.backend.domain.order.ShiftDiscrepancyLog::class.java to "shift_discrepancy_logs",
            com.sunpos.backend.domain.order.BuffetAdjustmentLog::class.java to "buffet_adjustment_logs",
            com.sunpos.backend.domain.order.ReceiptReprintLog::class.java to "receipt_reprint_logs",
            com.sunpos.backend.domain.order.PinSecurityLog::class.java to "pin_security_logs",
